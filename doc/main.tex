...
\begin{figure}[H]
    ...
    \begin{minipage}[c]{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{img/ratio_fptas_combined_boxplot.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{img/ratio_greedy_small_boxplot.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{img/ratio_all_combined_boxplot.png}
